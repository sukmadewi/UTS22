...
import com.example.uts22.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun showPasswordExistAlert(state: Boolean) {
        binding.edtPassword.error = if (state) "Password lenght less then 8" else null
    }
